...
<a
	...
	class="package-card glass-card block flex h-[160px] cursor-pointer flex-col justify-between p-5 no-underline"
	style="
		--index: {index};
...
>
	<div
		class="package-name text-lg leading-tight font-semibold break-all text-[var(--color-text-primary)]"
	>
		{name}
	</div>
	...
	<div class="flex items-end justify-between">
		...
		<div
			class="rounded-md px-3 py-1 font-mono text-sm font-medium"
